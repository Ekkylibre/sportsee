...
function Dashboard() {
  ...
  const fireIcon = <svg className="fireIcon" width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const chickenIcon = <svg className="chickenIcon" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const appleIcon = <svg className="appleIcon" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const burgerIcon = <svg className="burgerIcon" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
